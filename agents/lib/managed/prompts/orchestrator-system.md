...
Your final assistant message MUST be a single JSON object (no markdown fences around it) with this exact shape:

{
  "roster": [
    { "agent_id": "security-review", "project": "sidelineiq", "priority": "high", "reason": "active auth commits in last 7 days" }
  ],
  "skipped": [
    { "agent_id": "a11y-review", "project": "dosie", "reason": "no UI changes in 14 days" }
  ],
  "signals_summary": "3 projects had activity overnight, 2 at critical priority"
}

Do not wrap the JSON in a code fence. Do not emit any text after the JSON. The JSON is parsed by a downstream script expecting strict JSON.
